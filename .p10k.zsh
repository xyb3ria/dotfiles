# Generated by Powerlevel10k configuration wizard on 2023-07-03 at 12:41 -05.
 ...
 #  nodeenv                 # node.js environment (https://github.com/ekalinin/nodeenv)
  ...
  #  fvm                     # flutter version management (https://github.com/leoafarias/fvm)
   ...
   # jenv                    # java version from jenv (https://github.com/jenv/jenv)
    ...
    # erraform               # terraform workspace (https://www.terraform.io)
    # terraform_version     # terraform version (https://www.terraform.io)
    # aws                     # aws profile (https://docs.aws.amazon.com/cli/latest/userguide/cli-configure-profiles.html)
    # aws_eb_env              # aws elastic beanstalk environment (https://aws.amazon.com/elasticbeanstalk/)
  #   azure                   # azure account name (https://docs.microsoft.com/en-us/cli/azure)
 # g# # cloud                  # google cloud cli account and project (https://cloud.google.com/)
  ...
  #  midnight_commander      # midnight commander shell (https://midnight-commander.org/)
   ...
   #  c# hezmoi_shell           # chezmoi shell (https://www.chezmoi.io/)
    # v# # i_mode                 # vi mode (you don't need this if you've enabled prompt_char)
    # vpn_ip                # virtual private network indicator
    # load                  # CPU load
    # disk_usage            # disk usage
    # ram                   # free RAM
    # swap                  # used swap
    # odo                    # todo items (https://github.com/todotxt/todo.txt-cli)
    # imewarrior             # timewarrior tracking status (https://timewarrior.net/)
    # askwarrior             # taskwarrior task count (https://taskwarrior.org/)
